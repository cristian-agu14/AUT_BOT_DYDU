...
public class KnowledgesPage extends PageObject {
	...
	public static final Target BUTTON_CREATE = Target.the("Button for create a question")
			.locatedBy("//a[contains(text(), 'Create')]");
	...
	public static final Target BUTTON_CARD_ANSWER_QUESTION = Target
			.the("Button card answer to a question for the knowlege")
			.locatedBy("//span[contains(text(),'Answer to a question')]//ancestor::a[1]");
